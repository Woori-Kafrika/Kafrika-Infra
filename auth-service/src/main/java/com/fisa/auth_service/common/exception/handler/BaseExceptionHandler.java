...
import static com.fisa.auth_service.common.response.status.BaseExceptionResponseStatus.BAD_REQUEST;
import static com.fisa.auth_service.common.response.status.BaseExceptionResponseStatus.HTTP_MESSAGE_NOT_READABLE;
import static com.fisa.auth_service.common.response.status.BaseExceptionResponseStatus.METHOD_NOT_ALLOWED;
import static com.fisa.auth_service.common.response.status.BaseExceptionResponseStatus.SERVER_ERROR;
import static com.fisa.auth_service.common.response.status.BaseExceptionResponseStatus.URL_NOT_FOUND;

import com.fisa.auth_service.common.exception.BadRequestException;
import com.fisa.auth_service.common.exception.InternalServerErrorException;
